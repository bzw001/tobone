...
define(['canvas','ajax','sort_art_template','template','utile'],function(canvas,ToBone,article,template,utile){
    /*轮播图的设置*/
    ...
    /*替换方案。通过读取url来得到其他页面传来的参数*/
    (function(){
        var artId=utile.getUrlSearchStr('artId');
    ...
    (function(){
        ...
        ajax.ajax({
            ...
            success:function(result){
                ...
                pageNum=Math.ceil(commentLen/4);
